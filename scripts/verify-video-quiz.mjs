...
const checks = [
  ['package.json version 3.2.8', pkg.version === '3.2.8'],
  ['app.js APP_VERSION 3.2.8', appJs.includes("this.APP_VERSION = '3.2.8';")],
  ['index.html badge ver 3.2.8', html.includes('ver 3.2.8')],
  ...
  ['index.html firebase-config.js?v=328', html.includes('js/firebase-config.js?v=328')],
  ['index.html app.js?v=328', html.includes('js/app.js?v=328')],
  ['index.html quiz.js?v=328', html.includes('js/quiz.js?v=328')],
  ['index.html video_quiz.js?v=328', html.includes('js/video_quiz.js?v=328')],
  ['index.html song_quiz.js?v=328', html.includes('js/song_quiz.js?v=328')],
