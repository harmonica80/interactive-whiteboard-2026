...
const checks = [
  ['package.json version 3.3.1', pkg.version === '3.3.1'],
  ['app.js APP_VERSION 3.3.1', appJs.includes("this.APP_VERSION = '3.3.1';")],
  ['index.html badge ver 3.3.1', html.includes('ver 3.3.1')],
  ...
  ['index.html firebase-config.js?v=331', html.includes('js/firebase-config.js?v=331')],
  ['index.html app.js?v=331', html.includes('js/app.js?v=331')],
  ['index.html quiz.js?v=331', html.includes('js/quiz.js?v=331')],
  ['index.html video_quiz.js?v=331', html.includes('js/video_quiz.js?v=331')],
  ['index.html song_quiz.js?v=331', html.includes('js/song_quiz.js?v=331')],
