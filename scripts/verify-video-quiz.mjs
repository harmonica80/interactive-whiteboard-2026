...
const checks = [
  ['package.json version 3.3.2', pkg.version === '3.3.2'],
  ['app.js APP_VERSION 3.3.2', appJs.includes("this.APP_VERSION = '3.3.2';")],
  ['index.html badge ver 3.3.2', html.includes('ver 3.3.2')],
  ...
  ['index.html firebase-config.js?v=332', html.includes('js/firebase-config.js?v=332')],
  ['index.html app.js?v=332', html.includes('js/app.js?v=332')],
  ['index.html quiz.js?v=332', html.includes('js/quiz.js?v=332')],
  ['index.html video_quiz.js?v=332', html.includes('js/video_quiz.js?v=332')],
  ['index.html song_quiz.js?v=332', html.includes('js/song_quiz.js?v=332')],
