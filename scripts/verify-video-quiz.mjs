...
const checks = [
  ['package.json version 3.0.7', pkg.version === '3.0.7'],
  ['app.js APP_VERSION 3.0.7', appJs.includes("this.APP_VERSION = '3.0.7';")],
  ['index.html badge ver 3.0.7', html.includes('ver 3.0.7')],
