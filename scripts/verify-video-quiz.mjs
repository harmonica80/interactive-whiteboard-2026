...
const checks = [
  ['package.json version 3.5.0', pkg.version === '3.5.0'],
  ['app.js APP_VERSION 3.5.0', appJs.includes("this.APP_VERSION = '3.5.0';")],
  ['index.html badge ver 3.5.0', html.includes('ver 3.5.0')],
  ...
  ['index.html style.css?v=350', html.includes('css/style.css?v=350')],
  ['index.html firebase-config.js?v=350', html.includes('js/firebase-config.js?v=350')],
  ['index.html app.js?v=350', html.includes('js/app.js?v=350')],
  ['index.html quiz.js?v=350', html.includes('js/quiz.js?v=350')],
  ['index.html video_quiz.js?v=350', html.includes('js/video_quiz.js?v=350')],
  ['index.html song_quiz.js?v=350', html.includes('js/song_quiz.js?v=350')],
