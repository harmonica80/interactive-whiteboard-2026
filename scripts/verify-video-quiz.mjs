...
const checks = [
  ['package.json version 3.4.2', pkg.version === '3.4.2'],
  ['app.js APP_VERSION 3.4.2', appJs.includes("this.APP_VERSION = '3.4.2';")],
  ['index.html badge ver 3.4.2', html.includes('ver 3.4.2')],
  ...
  ['index.html style.css?v=342', html.includes('css/style.css?v=342')],
  ['index.html firebase-config.js?v=342', html.includes('js/firebase-config.js?v=342')],
  ['index.html app.js?v=342', html.includes('js/app.js?v=342')],
  ['index.html quiz.js?v=342', html.includes('js/quiz.js?v=342')],
  ['index.html video_quiz.js?v=342', html.includes('js/video_quiz.js?v=342')],
  ['index.html song_quiz.js?v=342', html.includes('js/song_quiz.js?v=342')],
