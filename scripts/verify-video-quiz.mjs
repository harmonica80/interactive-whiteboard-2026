...
const checks = [
  ['package.json version 3.2.9', pkg.version === '3.2.9'],
  ['app.js APP_VERSION 3.2.9', appJs.includes("this.APP_VERSION = '3.2.9';")],
  ['index.html badge ver 3.2.9', html.includes('ver 3.2.9')],
  ...
  ['index.html firebase-config.js?v=329', html.includes('js/firebase-config.js?v=329')],
  ['index.html app.js?v=329', html.includes('js/app.js?v=329')],
  ['index.html quiz.js?v=329', html.includes('js/quiz.js?v=329')],
  ['index.html video_quiz.js?v=329', html.includes('js/video_quiz.js?v=329')],
  ['index.html song_quiz.js?v=329', html.includes('js/song_quiz.js?v=329')],
