...
const checks = [
  ['package.json version 3.1.1', pkg.version === '3.1.1'],
  ['app.js APP_VERSION 3.1.1', appJs.includes("this.APP_VERSION = '3.1.1';")],
  ['index.html badge ver 3.1.1', html.includes('ver 3.1.1')],
