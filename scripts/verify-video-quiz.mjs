...
const checks = [
  ['package.json version 3.0.8', pkg.version === '3.0.8'],
  ['app.js APP_VERSION 3.0.8', appJs.includes("this.APP_VERSION = '3.0.8';")],
  ['index.html badge ver 3.0.8', html.includes('ver 3.0.8')],
