...
const htmlChecks = [
  ['index.html 包含 ver 3.3.4 版本標示', html.includes('ver 3.3.4')],
  ...
  ['引用 song_quiz_pool.js?v=334', html.includes('js/song_quiz_pool.js?v=334')],
  ['引用 song_quiz.js?v=334', html.includes('js/song_quiz.js?v=334')],
  ['引用 focus_question_bank.js?v=334', html.includes('js/focus_question_bank.js?v=334')],
  ['引用 app.js?v=334', html.includes('js/app.js?v=334')],
  ...
  ['成語測驗答題說明完整原典連結改用 introUrl', classicsQuizCode.includes('ref.introUrl || ref.fullTextUrl')],
...
const appChecks = [
  ['app.js APP_VERSION 為 3.3.4', appCode.includes("this.APP_VERSION = '3.3.4';")],
...
console.log('🎉 聽歌搶答 (songQuiz) ver 3.3.4 自主模式答對/答錯統計與成績顯示 60+ 項驗證均全數通過！');
