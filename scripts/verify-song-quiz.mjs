...
const htmlChecks = [
  ['index.html 包含 ver 3.4.5 版本標示', html.includes('ver 3.4.5')],
  ...
  ['引用 song_quiz_pool.js?v=345', html.includes('js/song_quiz_pool.js?v=345')],
  ['引用 song_quiz.js?v=345', html.includes('js/song_quiz.js?v=345')],
  ['引用 focus_question_bank.js?v=345', html.includes('js/focus_question_bank.js?v=345')],
  ['引用 app.js?v=345', html.includes('js/app.js?v=345')],
...
const appChecks = [
  ['app.js APP_VERSION 為 3.4.5', appCode.includes("this.APP_VERSION = '3.4.5';")],
