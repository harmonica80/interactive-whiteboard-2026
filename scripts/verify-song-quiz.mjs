...
const htmlChecks = [
  ['index.html 包含 ver 3.5.1 版本標示', html.includes('ver 3.5.1')],
  ...
  ['引用 song_quiz_pool.js?v=351', html.includes('js/song_quiz_pool.js?v=351')],
  ['引用 song_quiz.js?v=351', html.includes('js/song_quiz.js?v=351')],
  ['引用 focus_question_bank.js?v=351', html.includes('js/focus_question_bank.js?v=351')],
  ['引用 app.js?v=351', html.includes('js/app.js?v=351')],
...
const appChecks = [
  ['app.js APP_VERSION 為 3.5.1', appCode.includes("this.APP_VERSION = '3.5.1';")],
