...
const htmlChecks = [
  ['index.html 包含 ver 3.2.4 版本標示', html.includes('ver 3.2.4')],
  ...
  ['引用 song_quiz_pool.js?v=324', html.includes('js/song_quiz_pool.js?v=324')],
  ['引用 song_quiz.js?v=324', html.includes('js/song_quiz.js?v=324')],
  ['引用 focus_question_bank.js?v=324', html.includes('js/focus_question_bank.js?v=324')],
  ['引用 app.js?v=324', html.includes('js/app.js?v=324')]
];
...
const appChecks = [
  ['app.js APP_VERSION 為 3.2.4', appCode.includes("this.APP_VERSION = '3.2.4';")],
...
console.log('🎉 聽歌搶答 (songQuiz) 與標籤題庫管理體系全部 30+ 項單元驗證均全數通過！');
