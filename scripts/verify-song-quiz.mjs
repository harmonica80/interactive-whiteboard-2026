...
const htmlChecks = [
  ['index.html 包含 ver 3.5.0 版本標示', html.includes('ver 3.5.0')],
  ...
  ['引用 song_quiz_pool.js?v=350', html.includes('js/song_quiz_pool.js?v=350')],
  ['引用 song_quiz.js?v=350', html.includes('js/song_quiz.js?v=350')],
  ['引用 focus_question_bank.js?v=350', html.includes('js/focus_question_bank.js?v=350')],
  ['引用 app.js?v=350', html.includes('js/app.js?v=350')],
...
const appChecks = [
  ['app.js APP_VERSION 為 3.5.0', appCode.includes("this.APP_VERSION = '3.5.0';")],
