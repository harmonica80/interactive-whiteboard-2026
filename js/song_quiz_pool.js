...
(function (global) {
  ...
  const DEFAULT_SONG_QUIZ_POOL = [
    ...
    },
    {
      ...
      title: '甜蜜蜜',
      artist: '鄧麗君',
      youtubeUrl: 'https://www.youtube.com/watch?v=kYkyX11qgYw',
      youtubeId: 'kYkyX11qgYw',
      startTime: 15,
      duration: 15,
    ...
    },
    {
      ...
      title: '恰似你的溫柔',
      artist: '蔡琴',
      youtubeUrl: 'https://www.youtube.com/watch?v=t5Q3eQk_d60',
      youtubeId: 't5Q3eQk_d60',
      startTime: 25,
      duration: 15,
    ...
    },
    {
      ...
      title: '新鴛鴦蝴蝶夢',
      artist: '黃安',
      youtubeUrl: 'https://www.youtube.com/watch?v=KzKk7uM0F0c',
      youtubeId: 'KzKk7uM0F0c',
      startTime: 40,
      duration: 15,
    ...
    },
    {
      ...
      title: '朋友',
      artist: '周華健',
      youtubeUrl: 'https://www.youtube.com/watch?v=4YmI3gUe7hQ',
      youtubeId: '4YmI3gUe7hQ',
      startTime: 50,
      duration: 15,
    ...
    },
    {
      ...
      title: '愛拼才會贏',
      artist: '葉啟田',
      youtubeUrl: 'https://www.youtube.com/watch?v=d_kF1n9yX_w',
      youtubeId: 'd_kF1n9yX_w',
      startTime: 20,
      duration: 15,
    ...
    },
    {
      ...
      title: '家後',
      artist: '江蕙',
      youtubeUrl: 'https://www.youtube.com/watch?v=8l-V8p2lY-M',
      youtubeId: '8l-V8p2lY-M',
      startTime: 45,
      duration: 15,
    ...
    },
    {
      ...
      title: '童年',
      artist: '羅大佑',
      youtubeUrl: 'https://www.youtube.com/watch?v=2r1o_1y0l0A',
      youtubeId: '2r1o_1y0l0A',
      startTime: 15,
      duration: 15,
    ...
    },
    {
      ...
      title: '稻香',
      artist: '周杰倫',
      youtubeUrl: 'https://www.youtube.com/watch?v=sHD_z90E44U',
      youtubeId: 'sHD_z90E44U',
      startTime: 30,
      duration: 15,
    ...
    },
    {
      ...
      title: '勇氣',
      artist: '梁靜茹',
      youtubeUrl: 'https://www.youtube.com/watch?v=2X7TqB8aQ-0',
      youtubeId: '2X7TqB8aQ-0',
      startTime: 40,
      duration: 15,
    ...
    },
    {
      ...
      title: '簡單愛',
      artist: '周杰倫',
      youtubeUrl: 'https://www.youtube.com/watch?v=Y4x3ZDF7q_0',
      youtubeId: 'Y4x3ZDF7q_0',
      startTime: 25,
      duration: 15,
    ...
    },
    {
      ...
      title: '少年',
      artist: '夢然',
      youtubeUrl: 'https://www.youtube.com/watch?v=q6t8o7wN_1c',
      youtubeId: 'q6t8o7wN_1c',
      startTime: 30,
      duration: 15,
    ...
    },
    {
      ...
      title: '飛鳥和蟬',
      artist: '任然',
      youtubeUrl: 'https://www.youtube.com/watch?v=F_f8N2q_1gQ',
      youtubeId: 'F_f8N2q_1gQ',
      startTime: 30,
      duration: 15,
    ...
    },
    {
      ...
      title: '直到世界的盡頭',
      artist: 'WANDS',
      youtubeUrl: 'https://www.youtube.com/watch?v=0kFhP6X0Q_A',
      youtubeId: '0kFhP6X0Q_A',
      startTime: 40,
      duration: 15,
    ...
    },
    {
      ...
      title: '好想大聲說喜歡你',
      artist: 'BAAD',
      youtubeUrl: 'https://www.youtube.com/watch?v=s_K8U3WvX1A',
      youtubeId: 's_K8U3WvX1A',
      startTime: 15,
      duration: 15,
    ...
    },
    {
      ...
      title: '紅蓮華',
      artist: 'LiSA',
      youtubeUrl: 'https://www.youtube.com/watch?v=CwkzK-F0VW0',
      youtubeId: 'CwkzK-F0VW0',
      startTime: 15,
      duration: 15,
    ...
    },
    {
      ...
      title: '哆啦A夢之歌',
      artist: '大杉久美子',
      youtubeUrl: 'https://www.youtube.com/watch?v=gT1-Jz9_k_c',
      youtubeId: 'gT1-Jz9_k_c',
      startTime: 5,
      duration: 15,
    ...
    },
    {
      ...
      title: 'We Are!',
      artist: '北谷洋',
      youtubeUrl: 'https://www.youtube.com/watch?v=2T8u_z0fG0c',
      youtubeId: '2T8u_z0fG0c',
      startTime: 10,
      duration: 15,
    ...
    // --- 童謠兒歌 ---
    {
      ...
      title: '拔蘿蔔',
      artist: '傳統童謠',
      youtubeUrl: 'https://www.youtube.com/watch?v=G3Y1GZ8m2-o',
      youtubeId: 'G3Y1GZ8m2-o',
      startTime: 0,
      duration: 15,
    ...
    },
    {
      ...
      title: '兩隻老虎',
      artist: '傳統童謠',
      youtubeUrl: 'https://www.youtube.com/watch?v=q6bL7X_1_wU',
      youtubeId: 'q6bL7X_1_wU',
      startTime: 0,
      duration: 15,
    ...
    },
    {
      ...
      title: '當我們同在一起',
      artist: '傳統童謠',
      youtubeUrl: 'https://www.youtube.com/watch?v=4E-T4E_0-hA',
      youtubeId: '4E-T4E_0-hA',
      startTime: 0,
      duration: 15,
    ...
    },
    {
      ...
      title: '泥娃娃',
      artist: '傳統童謠',
      youtubeUrl: 'https://www.youtube.com/watch?v=5rT4E-0-hB8',
      youtubeId: '5rT4E-0-hB8',
      startTime: 0,
      duration: 15,
    ...
    },
    {
      ...
      title: '茉莉花',
      artist: '中國民謠',
      youtubeUrl: 'https://www.youtube.com/watch?v=yW_4r4F3hWw',
      youtubeId: 'yW_4r4F3hWw',
      startTime: 10,
      duration: 15,
    ...
    },
    {
      ...
      title: '小幸運',
      artist: '田馥甄',
      youtubeUrl: 'https://www.youtube.com/watch?v=_sQSXwdtnxY',
      youtubeId: '_sQSXwdtnxY',
      startTime: 40,
      duration: 15,
